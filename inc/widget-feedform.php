 ...
 * 
 */
class made_theme_feedform_widget extends WP_Widget {

  // Register widget with WordPress.

  public function __construct() {
    parent::__construct(
      'made-theme-feedform-widget', // Base ID
      'Feed Form Widget', // Name
  ...
  public function widget( $args, $instance ) {
    ...
    <div class="<?php echo $form_class;?>"> 
      ...
      <form class="input_group" action="https://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open('https://feedburner.google.com/fb/a/mailverify?uri=danamadeitblog', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true">
        <input type="text" name="email"/>
        <input type="hidden" value="danamadeitblog" name="uri"/>
...
add_action( 'widgets_init', 
  create_function( '', 'register_widget( "made_theme_feedform_widget" );' ) 
); ?>